...
public class MainActivity extends AppCompatActivity implements adapter_for_dishes.OnViewListener{
...
//        startActivity(intent);
    ...
    public void onViewClick(int position) {
        Intent intent=new Intent(MainActivity.this, Dish_Details.class);
       startActivity(intent);
    }
}
